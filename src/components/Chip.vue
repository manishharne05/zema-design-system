...
export default {
	...
	props: {
		...
		/**
		 * The Badge variant. There are 9 variants: 'turquoise', 'green', 'blue', 'dark',
		...
		/**
		 * Specifies the chip size. There are 3 sizes implemented: 'sm', 'md', 'lg'.
		 */
		size: {
			type: String,
			default: 'md',
	...
	emits: [
		/**
		* Event issued to manage chip selection value.
